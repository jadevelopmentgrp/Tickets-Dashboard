<script>
	...
	async function dispatchConfirm() {
		...
		if (dataFileInput.files.length > 0) frmData.append('data_file', dataFileInput.files[0]);
				...
				{#if queryLoading}
					<div>
						...
						<p style="text-align: center;">
							We are currently loading your data in, please do not navigate
							away from this page.
						</p>
					</div>
				{/if}
